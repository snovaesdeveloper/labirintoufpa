...
const index = require('./index-2652e807.js');
const ionicGlobal = require('./ionic-global-95eb86df.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
          Promise.resolve().then(function () { return require('./status-tap-5a99c24c.js'); }).then((module) => module.startStatusTap());
        }
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          ...
          Promise.resolve().then(function () { return require('./input-shims-cc986db7.js'); }).then((module) => module.startInputShims(ionicGlobal.config, platform));
        }
        ...
        if (typeof window !== 'undefined') {
          Promise.resolve().then(function () { return require('./keyboard-6d9f28b2.js'); }).then((module) => module.startKeyboardAssist(window));
        }
        Promise.resolve().then(function () { return require('./focus-visible-6163be3a.js'); }).then((module) => (this.focusVisible = module.startFocusVisible()));
      });
    }
  }
  /**
